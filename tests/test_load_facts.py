...
PROFILE_HEADER = (
    ...
    "residence_en,residence_tr,university_en,university_tr,employer_en,employer_tr,name_type,name_rarity_bucket,"
    "popularity_rank,popularity_bucket,profession_frequency_bucket,birthplace_frequency_bucket,residence_frequency_bucket,"
...
class TestLoadFacts(unittest.TestCase):
    ...
    def test_one_profile_row_expands_into_five_facts(self):
        """Tests that one subject profile expands into five internal facts."""
        facts = self.load_csv(
            ...
            "english_like,rare,1,high,high,medium,medium,low,high,A\n"
        )
    ...
    def test_relation_fields_and_frequencies_are_mapped_correctly(self):
        """Tests object and frequency mapping for all five relations."""
        facts = self.load_csv(
            "R0001,S0001,Leran Dovik,football player,futbolcu,London,Londra,"
            "Manchester,Manchester,"
            "Westbridge University,Westbridge Üniversitesi,Westbridge FC,Westbridge FC,"
        ...
        self.assertEqual(by_relation.loc["lives_in", "object_en"], "Manchester")
        ...
        self.assertEqual(by_relation.loc["lives_in", "frequency_bucket"], "medium")
