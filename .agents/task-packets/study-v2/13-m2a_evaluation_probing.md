...
Packet ID: `transfer-vs-relearning-m0-to-m2-eval-v2::m2a_evaluation_probing`
...
Scientific stage objective: Apply unchanged eval-v2 standard and factual probe bundles to M2-A.
