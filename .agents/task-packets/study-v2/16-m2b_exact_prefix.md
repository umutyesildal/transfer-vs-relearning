# Luna task packet — m2b_exact_prefix

Packet ID: `transfer-vs-relearning-m0-to-m2-eval-v2::m2b_exact_prefix`
...
Prepare or validate the local registered adapter for stage `m2b_exact_prefix`. Do not execute the
scientific stage from this packet.

Scientific stage objective: Run the unchanged historical exact-prefix supplement on every required M2-B checkpoint.
