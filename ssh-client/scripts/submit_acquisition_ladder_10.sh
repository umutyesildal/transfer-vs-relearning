...
"$PYTHON" scripts/m1/build_acquisition_ladder.py
"$PYTHON" -m pytest -q \
...
JOB_ID=$(sbatch --parsable \
  --export=ALL,TRAIN_CONFIG=configs/training/m1_smollm2_360m_acquisition_ladder_10_answer_only_lr5e-5_ep10.yaml \
