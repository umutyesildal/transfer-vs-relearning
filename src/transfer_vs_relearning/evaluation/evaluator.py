...
class CausalCandidateEvaluator:
    ...
    def run(self, resume: bool = False, force: bool = False, allow_errors: bool = False) -> Path:
        ...
        run_manifest = {
            ...
            "local_model_snapshot": str(_manifest_local_path(model_manifest, _resolve_path(self.config["model_manifest"]))),
            ...
            "parameter_count": model_manifest.get("parameter_count"),
