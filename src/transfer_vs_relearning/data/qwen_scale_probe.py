...
def build_qwen_scale_probe_dataset(repo_root: Path, *, output_dir: Path) -> Path:
    ...
    manifest.update({"version": VERSION, "four_form_probe_registry": str(probe_path), "four_form_probe_registry_sha256": sha256_file(probe_path), "four_form_probes": len(probes), "nested_100_subjects": sorted(summary["selected_subject_ids"])[:100]})
