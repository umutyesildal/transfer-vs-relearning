...
sbatch --test-only --export="${exports}" slurm/m1/eval_m1_dose_pareto_falcon_recovery_rtxa6000_exclusive.slurm
evaluation_id="$(sbatch --parsable --export="${exports}" slurm/m1/eval_m1_dose_pareto_falcon_recovery_rtxa6000_exclusive.slurm)"
summary_id="$(sbatch --parsable --dependency=afterok:${evaluation_id} --export="${exports}" slurm/m1/summarize_m1_dose_pareto_falcon_recovery_rtxa6000_exclusive.slurm)"
