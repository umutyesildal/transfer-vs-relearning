...
prior_root=/vol/tmp2/yesildau/vngrs_m2_oscar_phase2_evidence_v1
output_root=/vol/tmp2/yesildau/vngrs_m2_oscar_phase2_evidence_retry_v1
test -f "$prior_root/control/d0_failure.json"
test "$(sha256sum "$prior_root/control/d0_failure.json" | cut -d' ' -f1)" = a7c566f61427d67921091ac49ffb1debfc9632c7d401bfa99145755fab783c3f
test ! -e "$output_root"
