...
sbatch --test-only --export="${exports}" slurm/eval_m1_dose_pareto_falcon_audit_persistent_recovery.slurm
evaluation_id="$(sbatch --parsable --export="${exports}" slurm/eval_m1_dose_pareto_falcon_audit_persistent_recovery.slurm)"
summary_id="$(sbatch --parsable --dependency=afterok:${evaluation_id} --export="${exports}" slurm/summarize_m1_dose_pareto_falcon_audit_persistent_recovery.slurm)"
